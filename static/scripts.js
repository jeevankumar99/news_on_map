...
function addMarker(place)
{
    ...
    markers.push(marker);
    p_code = place["postal_code"];
    marker_loc[p_code] = marker;
    google.maps.event.addListener(marker_loc[p_code], "click", function(){
        parameters = { geo : place["postal_code"]};
        info_par = parameters.geo;
        inf = info_par.toString();
        $.getJSON("/articles", parameters, function(data) {
            showInfo(marker_loc[inf], data);
        });
    });
}
